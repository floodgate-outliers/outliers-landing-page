...
export const AlumniQuotesInfo: AlumniQuote[] = [
  ...
  },
  {
    ...
    date: 'Aug 03, 2021',
    quote:
      'Outliers made me more confident in taking a career path that might be different for the norm for people my age. I play into my strengths now regardless of what others think.',
  },
];
